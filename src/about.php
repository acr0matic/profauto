<?php $the_title = "О компании | ПрофАвто - соц. транспорт | оклейка, тенты"; ?>
<?php $the_description = "Крупный дистрибьютер спец. техники для Российских компаний. Услуги - лизинга, оклейки транспорта и оформления тентов" ?>
      ...
      <div class="hero">
        <div class="hero__content">
          ...
          <p class="hero__description section__description">
            Наша компания основана в 2019 году, на данный момент мы - крупный дистрибьютер спец. техники для Российских компаний, являемся центром компетенций в данном направлении. ПРОФАВТО работает с крупнейшими заводами по доработке коммерческого транспорта, а так же являемся партнером дистрибьюторов автомобильных марок ГАЗ, Mersedes-Bens, Volkswagen, Lada и другие. </p>
        ...
        <div class="row">
          <div class="col-6">
            ...
            <p class="section__text">
              ...
              ул. Ларина, 30.
              <br>
              Компания ПРОФАВТО имеет возможность осуществлять
              <br>
